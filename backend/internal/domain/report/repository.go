...
type Repository interface {
	...
	// on the given target, so a user cannot pile duplicates onto the queue.
	HasOpenFromReporter(ctx context.Context, targetType TargetType, targetID, reporterID uuid.UUID) (bool, error)
}
