...
// repository ports using pgx. Domain aggregates are kept free of persistence
// concerns; mapping happens here.
package postgres
...
// runs at most once. This keeps the project dependency-free for migrations.
